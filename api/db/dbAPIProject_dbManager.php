...
function getConnection() {
	...
	global $db_APIProject_db_Url, $db_APIProject_db_User, $db_APIProject_db_Pass, $db_APIProject_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_APIProject_db_Url.";dbname=".$db_APIProject_db_DbName, $db_APIProject_db_User, $db_APIProject_db_Pass);
